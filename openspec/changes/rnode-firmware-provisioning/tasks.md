...
- [ ] 2.1 Add failing Rust corpus-consumer tests for target observations, capabilities, plans, manifests, and outcomes
- [ ] 2.2 Add canonical RNode target, operation, plan, progress, recovery, and evidence types outside renderer crates
- [ ] 2.3 Retain RNode platform, MCU, model, hardware revision, firmware version, running hash, and target hash observations
