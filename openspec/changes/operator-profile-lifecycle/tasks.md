...
- [ ] Add failing typed IPC contract tests for inventory, create, promote, snapshot, restore, import, export, adoption, progress, and restart-required outcomes
- [ ] Implement the backend operations and authorization before changing frontend mode selection
