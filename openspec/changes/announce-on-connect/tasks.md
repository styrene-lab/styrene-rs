...
- [ ] 1.4 Verify on the phone: connect to the echo peer after a peer restart and receive an echo without a manual announce (first attempt showed the adapter never emits Connected; the worker now polls the connected state)
