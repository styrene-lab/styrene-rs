## 1. Content extraction gate
<!-- specs: nomadnet-crate-extraction -->
- [x] Register internal domain crate and document boundaries.
- [x] Extract projection, form codec and binary decoding with explicit IPC adapters.
- [x] Verify standalone contracts, daemon regressions, formatting, Clippy and workspace policy.
