...
- [ ] 1.5 Verify one workflow source change appears on both platforms without SwiftUI or Compose product-screen edits
...
- [ ] 4.2 Implement Swift adapters without product navigation or daemon domain state
- [ ] 4.3 Implement Kotlin adapters without product navigation or daemon domain state
...
- [ ] 5.1 Connect CoreBluetooth discovery, approval, protected access, reconnect, and byte transport to the shared Rust host
...
## 8. Physical Parity And Native Retirement
<!-- specs: mobile-ui -->

- [ ] 8.1 Compare each migrated workflow with its SwiftUI and Compose reference behavior
...
- [ ] 8.4 Approve or reject retirement separately for each workflow based on recorded parity evidence
- [ ] 8.5 Remove duplicate native product screens only after their workflow gates pass
- [ ] 8.6 Retain required Swift and Kotlin platform adapters and remove obsolete native domain state
...
- [ ] 9.5 Publish migration status, remaining native references, physical evidence gaps, and rollback instructions
