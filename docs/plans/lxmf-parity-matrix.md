...
| LXMF/LXMessage.py | src/message/* | partial | tests/message_payload_parity.rs, tests/message_wire_parity.rs, tests/message_storage_parity.rs, tests/message_object_parity.rs | payload/content/title/storage container; pack/unpack/signatures pending |
