...
| LXMF/LXMessage.py | src/message/* | partial | tests/message_payload_parity.rs, tests/message_wire_parity.rs, tests/message_storage_parity.rs, tests/message_object_parity.rs, tests/message_pack_parity.rs, tests/propagation_pack_parity.rs, tests/paper_pack_parity.rs | payload/content/title/storage container; wire + propagation + paper packing parity; remaining delivery/transport metadata |
