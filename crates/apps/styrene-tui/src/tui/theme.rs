...
pub trait Theme: Send + Sync {
    ...
    fn sent_msg_bg(&self) -> Color {
        self.card_bg()
    }
    fn received_msg_bg(&self) -> Color {
        Color::Rgb(3, 12, 20)
    }
    fn event_bg(&self) -> Color {
        self.surface_bg()
    }
    fn link_active(&self) -> Color {
        self.success()
    }
    fn link_stale(&self) -> Color {
        self.warning()
    }
    fn link_closed(&self) -> Color {
        self.muted()
    }
    fn peer_online(&self) -> Color {
        self.success()
    }
    fn peer_offline(&self) -> Color {
        self.muted()
    }
    fn signal_strong(&self) -> Color {
        self.success()
    }
    fn signal_weak(&self) -> Color {
        self.caution()
    }
    fn signal_none(&self) -> Color {
        self.error()
    }
